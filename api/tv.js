...
throw new Error(
Fetch failed ${resp.status} ${resp.statusText} for ${target} :: ${text.slice(   0,   200   )}
);
}
...
try {
const apiUrl = https://multi-movies-api.vercel.app/api/video.js?url=${encodeURIComponent(   target   )};
